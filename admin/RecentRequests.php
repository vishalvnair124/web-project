...
<div class="report-container">
    ...
    <?php
    $requestsSQL = "SELECT blood_requests.*,users.name FROM `blood_requests` WHERE blood_requests.request_status=1 OR blood_requests.request_status=3 ORDER BY request_id DESC ";
